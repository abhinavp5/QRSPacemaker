# '''
# Logic for taking in a chain of impulses and implementing Open Loop Packemaker
# For the sake of simplicity this implementation follow a Single - chamber packemaker,
